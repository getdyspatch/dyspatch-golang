...
/*
GetDraftLocalizationById Get Draft Localization Object by ID
...
*/
func (a *LocalizationsApiService) GetDraftLocalizationById(ctx _context.Context, draftId string, localizationId string, targetLanguage string, accept string) (LocalizationRead, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/localizations/{localizationId}/drafts/{draftId}"
...
/*
GetPublishedLocalizationById Get Localization Object by ID
...
@return LocalizationRead
*/
func (a *LocalizationsApiService) GetPublishedLocalizationById(ctx _context.Context, localizationId string, targetLanguage string, accept string) (LocalizationRead, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
